...
CREATE TABLE JourFeries(
        ...
        libelle   Varchar (25) ,
        PRIMARY KEY (dateFerie )
)ENGINE=InnoDB;

insert into JourFeries values('2018-01-01','Happy New Year');
insert into JourFeries values('2018-04-02','Lundi de Pâques');
insert into JourFeries values('2018-05-01','Fête du travail');
insert into JourFeries values('2018-05-08','8 mai 1945');
insert into JourFeries values('2018-05-10','Ascension');
insert into JourFeries values('2018-05-20','Pentecôte');
insert into JourFeries values('2018-07-14','Fête Nationale');
insert into JourFeries values('2018-11-11','Armistice');
insert into JourFeries values('2018-12-25','Noël');
